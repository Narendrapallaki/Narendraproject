package com.employee.ApplicationException;
...
public class ExceptionApplication
{
   ...
   public Map<String,String> validateException(MethodArgumentNotValidException ex){
	...
	/*@ResponseStatus(HttpStatus.BAD_REQUEST) @ExceptionHandler(UserNotFoundException.class) 
	 public Map<String,String> methodException(UserNotFoundException ex){
			Map<String,String> errorsMap=new HashMap<>();
